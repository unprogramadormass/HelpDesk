...
<head>
    ...
    <title>Agent Dashboard | HelpDesk</title>
...
<body class="bg-slate-50 text-slate-800 dark:bg-darkbg dark:text-slate-200 theme-transition">
    ...
    <!-- HEADER JS  -->
    <script>
        // Pasar el ID del usuario en sesión desde PHP a JS
    ...
    <script src="../../../assets/js/agent/dashboard/get-dashboard.js"></script>
    ...
    <script src="../../../assets/js/agent/tickets/tickets.view.js"></script>
    <script src="../../../assets/js/agent/tickets/my-tickets.view.js"></script>
